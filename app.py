...
BOT_FALLBACK_TWEETS = {
    ...
    'imp_collapse': [
        "絶対彼氏にした方がいい男の特徴\n\n・背が高い\n・たくさん甘やかしてくれる\n・喧嘩しても話し合いできる\n・存護\n・物理\n・味方キャラが「同袍」になった時、その味方に「龍霊」を召喚する。「龍霊」の初期速度は165。\n・「龍霊」が行動する時、味方それぞれのデバフを1つ解除し、攻撃力10%+200の",
        "【信用できる人の見分け方】\n\n・約束を守る\n・時間にルーズじゃない\n・陰口を言わない\n・困った時に助けてくれる\n・HP80000\n・DEF4500\n・スキル1:全体攻撃+味方HP20%回復\n・スキル2:ランダムに3体攻撃+確率でスタン\n・覚醒スキル:敵全体の",
        "やって良かった自己投資TOP5\n\n1. 読書（月10冊）\n2. 筋トレ（週3回）\n3. 英語学習\n4. ブログ\n5. 素材：ミスリル鋼×5、竜の逆鱗×2、虹色鉱石×1\n鍛造時間：4時間30分\n強化上限：+15\nセット効果：HP+2000、会心率+12%",
        "転職で年収上がった方法\n\n・市場価値を知る\n・スキルの棚卸し\n・職務経歴書を毎月更新\n・面接では\n\nすみません、ここから先はLv.50以上のユーザーのみ閲覧できます。\n\n課金してアンロックしますか？\n→はい\n→いいえ（広告を見る）",
        "人生で大切なこと\n\n・健康\n・家族\n・友人\n・お金\n・時間\n・※このツイートは広告です※\n・今なら初回80%OFF\n・送料無料\n・定期購入で更にお得\n・解約はお電話のみ\n・受付時間 平日10:00-10:05",
        "👦「お名前はなんて言うんですか？」\n\n👧「私の名前〜？神奈川県の高校から取った名前だよ」\n\n👦（翠嵐高校の翠ちゃんとかなぁ…可愛い名前だな///）\n\n👧「あ、ママー！」\n\n👩「あら、横浜市立横浜サイエンスフロンティアちゃん〜早く帰るわよ〜」",
        "年収別「お金の最適解」\n\n【年収800万円〜】\nふるさと納税 ＝ iDeCo ＝ NISA\n\n【年収700万円】\nふるさと納税 ＝ iDeCo ＞ NISA\n\n【年収600万円】\nふるさと納税 ＝ NISA ＞ iDeCo\n\n【年収500万円〜300万円】\nまず生きろ",
        "絶対彼女にした方がいい女の特徴\n\n・笑顔が素敵\n・話をちゃんと聞いてくれる\n・一緒にいて落ち着く\n・HP999999\n・全属性耐性80%\n・パッシブ:周囲の味方のATK+40%\n・固有スキル「絶対領域」:3ターンの間、味方全員に無敵付与\n・覚醒後:宇宙を創造する",
    ],
}
